(function () {
  ...
  Game.prototype.addEnemies = function () {
    var a = 0;
    while (a < 200){
      for (var i = 0; i < Game.NUM_ENEMIES_PER_ROW; i++) {
        this.add(new SpaceInvaders.Alien({
          game: this, pos: [40 * i, a], hp: this.currentLevel * 100
        }));
      }
  ...
  Game.prototype.enemiesFire = function(){
    for (var i = 0; i < this.enemies.length; i++){
      if (Math.random() >= .9995 - (.0005 * this.currentLevel)){
